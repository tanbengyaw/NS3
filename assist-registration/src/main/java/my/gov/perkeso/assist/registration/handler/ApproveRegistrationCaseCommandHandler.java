...
@Service
@CommandType(entity = "REGISTRATION_CASE", action = "APPROVE")
@RequiredArgsConstructor
public class ApproveRegistrationCaseCommandHandler implements CommandHandler {
    ...
    public CommandProcessingResult processCommand(final JsonCommand command) {
        return writeService.approveCase(command);
    }
}
