...
@Service
@CommandType(entity = "REGISTRATION_CASE", action = "REJECT")
@RequiredArgsConstructor
public class RejectRegistrationCaseCommandHandler implements CommandHandler {
    ...
    public CommandProcessingResult processCommand(final JsonCommand command) {
        return writeService.rejectCase(command);
    }
}
