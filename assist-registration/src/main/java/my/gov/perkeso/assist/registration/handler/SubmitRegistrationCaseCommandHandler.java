...
@Service
@CommandType(entity = "REGISTRATION_CASE", action = "SUBMIT")
@RequiredArgsConstructor
public class SubmitRegistrationCaseCommandHandler implements CommandHandler {
    ...
    public CommandProcessingResult processCommand(final JsonCommand command) {
        return writeService.submitCase(command);
    }
}
