...
@Service
@CommandType(entity = "REGISTRATION_CASE", action = "QUERY")
@RequiredArgsConstructor
public class QueryRegistrationCaseCommandHandler implements CommandHandler {
    ...
    public CommandProcessingResult processCommand(final JsonCommand command) {
        return writeService.queryCase(command);
    }
}
