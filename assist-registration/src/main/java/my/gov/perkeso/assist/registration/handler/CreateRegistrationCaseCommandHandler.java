...
@Service
@CommandType(entity = "REGISTRATION_CASE", action = "CREATE")
@RequiredArgsConstructor
public class CreateRegistrationCaseCommandHandler implements CommandHandler {
    ...
    public CommandProcessingResult processCommand(final JsonCommand command) {
        return writeService.createCase(command);
    }
}
